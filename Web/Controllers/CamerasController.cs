...
namespace Web.Controllers
{
    public class CamerasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCamera,MAC,IP,Modelo,Local,NumeroSerie")] Camera camera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCamera,MAC,IP,Modelo,Local,NumeroSerie")] Camera camera)
        {
